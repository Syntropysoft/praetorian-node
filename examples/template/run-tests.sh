...
# 🧪 Test Script for [EXAMPLE_NAME] - Praetorian Examples
# This script runs all [TYPE_OF_TESTS] tests
#
# CONFIGURATION:
...
TEST_CASES=(
    ...
    "configs/[config1.yaml]" "SUCCESS" "Correct [config1] configuration"
    "configs/[config2.json]" "SUCCESS" "Correct [config2] configuration"
    
    # Incorrect configurations
    "invalid/[broken1.yaml]" "FAILURE" "[config1] configuration with errors"
    "invalid/[broken2.json]" "FAILURE" "[config2] configuration with errors"
)
...
echo "🧪 Praetorian Examples - Running [TYPE_OF_TESTS] Tests"
echo "=========================================================="
