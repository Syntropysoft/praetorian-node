...
# 🧪 Test Script for Security Audit - Praetorian Examples
...
TEST_CASES=(
    ...
    "configs/secure-app.yaml" "SUCCESS" "Secure application configuration"
    
    # Insecure configurations
    "invalid/insecure-app.yaml" "FAILURE" "Insecure application configuration"
)
